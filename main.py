...
if __name__ == "__main__":
    ...
    if hashes.listings:
        ...
        for entry in hashes.listings:
            ...
            torrent_path = os.path.join(os.path.expanduser("~"), DOWNLOAD_LOCATION, f"{description}.torrent")
        ...
        time_vault.set(pendulum.parse(hashes.listings[-1].published, strict=False))
